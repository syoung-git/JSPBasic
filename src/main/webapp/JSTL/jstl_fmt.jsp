...
<body>
	...
	<h3>아래 값을 2020년05월03일 21시30분22초로 변경 출력</h3>
	<c:set var="e" value="2020-05-03 21:30:22"/>
	<c:set var="f" value="<%=new Date() %>" />
	
	<fmt:parseDate var="res" value="${e }" pattern="yyyy-MM-dd HH:mm:ss" />
	<fmt:formatDate value="${res }" pattern="yyyy년 MM월 dd일 HH:mm:ss"/>
	
	<br>
	<fmt:formatDate value="${f }" pattern="yyyy년 MM월 dd일 HH:mm:ss" />
